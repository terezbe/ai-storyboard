...
import { Sparkles, ImagePlus, Video, Loader2, AlertCircle, RefreshCw, Link2, Scissors } from 'lucide-react';
      ...
      <div className="rounded-lg border border-border overflow-hidden">
        ...
        {shot.orderIndex > 0 && (
          <div className="px-3 py-2 border-t border-border flex items-center gap-2">
            <span className="text-xs text-text-muted">{t('shot.continuityMode')}</span>
